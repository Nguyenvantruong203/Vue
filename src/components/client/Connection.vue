        ...
        <div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
            <div class="flex flex-wrap text-center justify-center">
                <div class="w-full lg:w-6/12 px-4">
                    <h2 class="text-4xl font-semibold text-white">Develop forever</h2>
                    <p class="text-lg leading-relaxed mt-4 mb-4 text-gray-500">
                        Make sure you provide a quality and reliable product or service. Not only meeting current customer
                        needs, but
                        also continuously improving and developing your products/services.
                    </p>
                </div>
            </div>
